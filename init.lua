...
do
  ...
  -- Load project-local config files (`.nvim.lua` / `.nvimrc` / `.exrc`) from the
  -- directory Neovim is launched in. Neovim prompts to `:trust` them on first
  -- load. Used here so Askama projects can map `.html` -> the `askama` filetype.
  -- See `:help 'exrc'`
  vim.o.exrc = true
